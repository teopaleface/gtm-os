---
name: gtm-ai-visibility
description: "Audit whether a product is discoverable in AI answers for buyer questions."
---

# AI search visibility

Measure a narrow set of real buyer questions. Treat an AI answer as a sampled output, not a stable market ranking.
...
Read `../../references/evidence-policy.md`, `../../references/source-adapters.md`, and `../../references/artifact-contract.md`.

## Completion

The audit has a reproducible prompt set, dated observations, source links, a coverage caveat, and a next measurement.
