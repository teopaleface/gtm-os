...
## Page score
Overall: `UNSCORABLE`; audit coverage: 47%, below the 50% threshold. The category table, criterion ratings, evidence notes, and arithmetic are in `demo/output/product-page-score.md`. Critical blocker: the selected variant renders `Sale Out of Stock`.
## Scope
