...
`gtm-product-page-audit` is the focused e-commerce workflow: one public product page, a 100-point conversion, SEO, GEO, and experience score with audit coverage, optional comparison context, a claim ledger, product-data coverage, and up to three pre-traffic changes. It does not replace the broader GTM workflow; it is a small, explicit playbook that can stand alone in a timed demo.
